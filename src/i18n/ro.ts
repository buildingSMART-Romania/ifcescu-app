...
export const ro = {
  ...
  help: {
    ...
    qtoTitle: "Calcul de cantități din geometrie (experimental)",
    qtoBody:
      "• Se activează din Setări → Experimental; implicit este oprit.\n• Butonul calculator din Tabelul de date derivă cantitățile din geometria 3D pentru toate elementele — volum, arii, dimensiuni — cu numele standard din setul Qto_ al clasei (ex. Qto_WallBaseQuantities.NetVolume, Qto_CourseBaseQuantities la straturile rutiere); clasele fără set standard primesc unul derivat după același tipar.\n• Valorile se scriu automat pe elemente ca seturi Qto; cantitățile autorate existente nu sunt atinse niciodată. Descarcă IFC-ul pentru a le păstra.\n• Elementele subțiri de tip suprafață (strate rutiere, plăci, rampe) se măsoară pe fața superioară: lungimea urmează curbura, iar grosimea nu e umflată de pantă.\n• Toate cantitățile se afișează uniform în m / m² / m³ (3 zecimale), cu simbolul unității; în fișier valorile se scriu în unitățile declarate ale modelului.\n• Valorile sunt aproximări derivate din geometria triangulată — verifică-le înainte de utilizare contractuală.",
