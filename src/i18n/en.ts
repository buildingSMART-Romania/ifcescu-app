...
export const en: Dict = {
  ...
  analytics: {
    ...
    cardTitle: "Title",
    titlePlaceholder: "Automatic",
    byDim: "{measure} by {dim}",
    dimension: "Dimension",
    measure: "Measure",
    bins: "Bins",
    sortLabel: "Sort",
    ...
    scatterX: "X axis",
    scatterY: "Y axis",
    scatterSize: "Bubble size",
    sizeNone: "None",
    slicerSearch: "Search values…",
    slicerMore: "{n} more — refine the search",
    slicerClear: "Clear",
    exportCsv: "Export CSV",
    ...
    fieldMissing: "Field \"{field}\" is not available in the loaded model(s).",
  },
  clash: {
    tab: "Clashes",
    ...
    search: "Search element, model, GUID…",
  ...
  ids: {
    ...
    create: "Create IDS",
    edit: "Edit IDS",
    discardDraft: "Discard IDS",
    confirmDiscard: "Discard the current IDS? This removes the draft and its report.",
    discard: "Discard",
    ...
    bcfPreparing: "Preparing BCF…",
    bcfGenerating: "Generating viewpoints… {done}/{total}",
    attachViews: "Attach view snapshots",
    searchEntities: "Search non-conforming elements…",
    reportTitle: "Printable report (PDF)",
    report: {
      heading: "IDS validation report",
      model: "Model",
      schema: "Schema",
      elements: "Entities",
      spec: "Specification",
      ...
      expected: "Expected",
      actual: "Actual",
      more: "+{n} more failing elements — see the CSV export for the full list.",
    },
  },
  idsEditor: {
    title: "IDS creator",
    ...
    export: "Export .ids",
    sessionNote: "Your work is kept if you close this editor",
    confirmNew: "Start a new document? The current draft will be replaced.",
    confirmLoad: "Load \"{name}\"? The current draft will be replaced.",
    replace: "Replace",
    ...
    date: "Date",
    datePh: "YYYY-MM-DD",
    dateInvalid: "Date must be YYYY-MM-DD (IDS schema); otherwise it's omitted on export.",
    purpose: "Purpose",
    milestone: "Milestone",
    copyright: "Copyright",
  ...
  filter: {
    ...
    ruleName: "Name",
    addClass: "add class…",
    addContainer: "add storey / building…",
    contains: "contains",
    equals: "equals",
    regex: "regex",
  ...
  bcf: {
    ...
    topicsHead: "Topics ({n})",
    topicsFiltered: "Topics ({n} of {total})",
  ...
  models: {
    ...
    confirmRemove: "Remove this model?",
  ...
  help: {
    ...
    qtoTitle: "Quantity takeoff from geometry (experimental)",
    qtoBody:
      "• Enable it in Settings → Experimental; off by default.\n• The calculator button in the Data table derives quantities from the 3D geometry for every element — volume, areas, dimensions — under the class's standard Qto_ set names (e.g. Qto_WallBaseQuantities.NetVolume, Qto_CourseBaseQuantities for road layers); classes without a standard set get one derived on the same pattern.\n• The values are written onto the elements as Qto sets automatically; existing authored quantities are never touched. Download the IFC to keep them.\n• Thin surface-like elements (road courses, slabs, ramps) are measured on their top face: lengths follow curvature and thickness is not inflated by slope.\n• All quantities display uniformly in m / m² / m³ (3 decimals) with unit symbols; the file stores values in its own declared units.\n• Values are approximations derived from the triangulated geometry — verify before contractual use.",
    analyticsTitle: "Analytics (experimental)",
    analyticsBody:
      "• Enabled from Settings -> Experimental features; hidden by default.\n• The Analytics button opens a dashboard in a resizable bottom dock (drag the top edge), with the 3D visible above it; visuals can be moved and resized (drag & resize, snapped to a grid), like a Power BI report. The dashboard layout is saved automatically and restored on reopen.\n• Types: bars, donut, treemap, stacked bars (2 dimensions), histogram, line, area, ranked list, scatter/bubble, gauge (with a target), KPI cards and a slicer (searchable checkbox filter). Configure each visual from its gear popover: dimension, measure (count/sum/avg/min/max), sort, top-N with an Others bucket, value labels, editable title.\n• Clicking a category filters everything: the other charts recompute (cross-filter) and the 3D isolates + colors the elements. Combine OR within a chart, AND across charts; on stacked bars, clicking the legend filters by the second dimension.\n• Per-card export: CSV (data) and PNG (chart image). Maximize any tile with 🗖.\n• \"Reset\" brings everything back.",
