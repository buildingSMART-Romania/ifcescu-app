    ...
    <div className="ids-panel">
      <div className="ids-head">
        ...
        <div className="ids-head-actions">
          <button className="ids-icon" title={t("bcf.resetView")} aria-label={t("bcf.resetView")} onClick={onResetView}>
          ...
          <button className="ids-icon" title={t("bcf.import")} aria-label={t("bcf.import")} onClick={() => importRef.current?.click()} disabled={busy}>
          ...
          <button className="ids-icon" title={t("bcf.export")} aria-label={t("bcf.export")} onClick={onExport} disabled={busy || topics.length === 0}>
          ...
          <button className="ids-icon" title={t("common.close")} aria-label={t("common.close")} onClick={onClose}>
            ×
          </button>
        </div>
      </div>
